...
export const metadata: Metadata = {
  ...
  description: '台北黃金免費估價！專業儀器鑑定K金、白金、鑽石，老闆親自操作，公開透明。估完不賣可直接帶走，電話 0986-821-626。 台北巧品珠寶鑑定師L親自鑑定，10年以上珠寶鑑定資歷，透明報價不扣耗損，台北大安區濟南路三段62-1號，提供免費估價與諮詢服務。',
  ...
  openGraph: {
    ...
    images: [{ url: 'https://res.cloudinary.com/dakafmdhy/image/upload/v1775486783/gold-tw/gold-appraise-cover.png', width: 1200, height: 630, alt: 'gold-appraise 專業珠寶鑑定估價' }],
  ...
  return (
    <main style={{ padding: '2rem', maxWidth: '800px', margin: '0 auto' }}>
      ...
      <div style={{ margin: '1.5rem 0', borderRadius: '12px', overflow: 'hidden' }}>
        <Image
          src="https://res.cloudinary.com/dakafmdhy/image/upload/v1775486783/gold-tw/gold-appraise-cover.png"
          alt="gold-appraise 專業珠寶鑑定估價"
          width={1200}
          height={630}
