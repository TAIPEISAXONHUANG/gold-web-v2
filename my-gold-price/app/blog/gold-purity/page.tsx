      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "FAQPage",
            "mainEntity": [
              { "@type": "Question", "name": "24K和18K差多少？", "acceptedAnswer": { "@type": "Answer", "text": "24K含金量99.9%、18K含金量75%。同重量的話，18K回收價約為24K的75%。" } },
              { "@type": "Question", "name": "怎麼知道我的金飾是幾K？", "acceptedAnswer": { "@type": "Answer", "text": "看金飾上的印記：999=24K、750=18K、585=14K、417=10K。也可以到店用儀器檢測。" } },
              { "@type": "Question", "name": "純度檢測會弄壞金飾嗎？", "acceptedAnswer": { "@type": "Answer", "text": "XRF螢光分析是非破壞性檢測，不會損傷物品。火燒測試才會留下痕跡，會事先徵得同意。" } }
            ]
          })
        }}
      />
