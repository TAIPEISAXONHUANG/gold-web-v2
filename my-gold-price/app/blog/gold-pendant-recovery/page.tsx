...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: '黃金、鑽石吊墜高價回收！各款式吊墜、寶石墜子均可估價。台北巧品珠寶免費專業鑑定，當場現金付款，電話 0986-821-626。',
    type: 'article',
    url: 'https://www.gold-tw.com/blog/gold-pendant-recovery',
    siteName: '巧品珠寶',
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "mainEntity": [
              {
                "@type": "Question",
                "name": "Can religious pendants be sold?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Yes, this is entirely your personal choice."
                }
              },
              {
                "@type": "Question",
                "name": "My pendant has small diamonds - how are they priced?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Gold and diamonds are appraised separately with full transparency."
                }
              }
            ]
          })
