...
export const metadata: Metadata = {
  ...
  description: '想知道10mg黃金值多少錢？本文提供2026年台灣黃金換算公式、克重行情對照表，一次搞懂10毫克黃金的實際價值與回收參考價。 台北巧品珠寶鑑定師L親自鑑定，10年以上珠寶鑑定資歷，透明報價不扣耗損，台北大安區濟南路三段62-1號，提供免費估價與諮詢服務。',
  openGraph: {
    locale: 'zh_TW',
    type: 'article',
    ...
    images: [{ url: 'https://res.cloudinary.com/dakafmdhy/image/upload/v1775485292/gold-tw/10mg-gold-price-2026-cover.png', width: 1200, height: 630, alt: '10mg-gold-price-2026 專業珠寶鑑定估價' }],
  },
}
  ...
  return (
    <main style={{ maxWidth: '780px', margin: '0 auto', padding: '24px 16px', fontFamily: 'sans-serif', color: '#1a1a1a' }}>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        mainEntityOfPage: {
          '@type': 'WebPage',
          '@id': 'https://www.gold-tw.com/blog/10mg-gold-price-2026',
        },
        image: {
          '@type': 'ImageObject',
        ...
        inLanguage: 'zh-TW',
        keywords: '黃金回收, 巧品珠寶, 10mg黃金多少錢, 2026換算公式與即時參考價格',
      ...
      <div style={{ margin: '1.5rem 0', borderRadius: '12px', overflow: 'hidden' }}>
        <Image
          src="https://res.cloudinary.com/dakafmdhy/image/upload/v1775485292/gold-tw/10mg-gold-price-2026-cover.png"
          alt="10mg-gold-price-2026 專業珠寶鑑定估價"
          width={1200}
          height={630}
      ...
      <div style={{ background: '#fffbeb', borderLeft: '4px solid #f59e0b', padding: '16px', margin: '16px 0', borderRadius: '8px' }}>
        <strong>重點摘要：</strong> 想知道10mg黃金值多少錢？本文提供2026年台灣黃金換算公式、克重行情對照表，一次搞懂10毫克黃金的實際價值與回收參考價。
      </div>
