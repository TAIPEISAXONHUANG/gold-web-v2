...
export const metadata: Metadata = {
  ...
  description: '黃金項鍊高價回收！各款式K金項鍊均可，按重量計價不扣耗損。台北巧品珠寶老闆親自鑑定，當場現金，電話 0986-821-626。 台北巧品珠寶鑑定師L親自鑑定，10年以上珠寶鑑定資歷，透明報價不扣耗損，台北大安區濟南路三段62-1號，提供免費估價與諮詢服務。',
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "mainEntity": [
              {
                "@type": "Question",
                "name": "My necklace is broken - does that reduce the price?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "No, we price by weight so broken necklaces get the same price."
                }
              },
              {
                "@type": "Question",
                "name": "My necklace has a pendant - how is it priced?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Gold chain and pendant are weighed together; gemstones estimated separately."
                }
              }
            ]
          })
