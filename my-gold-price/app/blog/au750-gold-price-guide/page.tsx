...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: 'https://res.cloudinary.com/dakafmdhy/image/upload/v1775485711/gold-tw/au750-gold-price-guide-cover.png', width: 1200, height: 630, alt: 'au750-gold-price-guide 專業珠寶鑑定估價' }],
  ...
  return (
    <>
      ...
      <div style={{ margin: '1.5rem 0', borderRadius: '12px', overflow: 'hidden' }}>
        <Image
          src="https://res.cloudinary.com/dakafmdhy/image/upload/v1775485711/gold-tw/au750-gold-price-guide-cover.png"
          alt="au750-gold-price-guide 專業珠寶鑑定估價"
          width={1200}
          height={630}
