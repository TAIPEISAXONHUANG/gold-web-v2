...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: '黃金耳環高價回收！各款式K金耳環、墜子均可，按重量現金付款不扣耗損。台北巧品珠寶免費估價，電話 0986-821-626。',
    type: 'article',
    url: 'https://www.gold-tw.com/blog/gold-earring-recovery',
    siteName: '巧品珠寶',
...
export default function Page() {
  return (
    <main style={{ padding: '2rem', maxWidth: '800px', margin: '0 auto' }}>
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "mainEntity": [
              {
                "@type": "Question",
                "name": "I only have one earring, can it be recovered?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Yes, we price by weight so single earrings are accepted."
                }
              },
              {
                "@type": "Question",
                "name": "My earrings have small diamonds, how are they priced?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Gold and diamonds are estimated separately, we give you a total."
                }
              }
            ]
          })
      ...
      <h2>Even small gold earrings are worth recovering?</h2>
