...
export const metadata: Metadata = {
  ...
  description: '黃金手鍊、手環高價回收！各款式K金手鍊均可，按重量計價不扣耗損。台北巧品珠寶當場現金付款，電話 0986-821-626。 台北巧品珠寶鑑定師L親自鑑定，10年以上珠寶鑑定資歷，透明報價不扣耗損，台北大安區濟南路三段62-1號，提供免費估價與諮詢服務。',
  ...
  openGraph: {
    ...
    type: 'article',
    url: 'https://www.gold-tw.com/blog/gold-bracelet-recovery',
    siteName: '巧品珠寶',
          ...
          __html: JSON.stringify({
            ...
            "mainEntity": [
              ...
              },
              {
                ...
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "完全可以，我們以重量和純度計價，外觀不影響回收價格。"
                }
              }
            ]
          })
