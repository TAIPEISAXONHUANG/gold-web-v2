...
export default function FaqPage() {
  const faqs = [
    {
      q: '黃金回收價格怎麼計算？',
      a: '黃金回收價格 = 當日牌價 × 重量 × 純度。我們採用公開透明的計價方式，足9999不扣耗損，當日現金支付。'
    },
    {
      q: '賣黃金需要帶什麼證件？',
      a: '請攜帶身份證+雙證件，我們需要進行實名制登記，這是政府規定的法定程序。'
    },
    {
      q: '你們的回收價格比別家好嗎？',
      a: '我們提供台灣市場頂端回收價，不扣秤、不扣耗損公開透明。建議您多方比價後再決定。'
    },
    {
      q: 'K金、18K金可以回收嗎？',
    ...
    {
      q: '賣黃金要本人到場嗎？',
      a: '是的，需要本人到場並出示身份證正本進行實名登記，也可以使用寄送他縣市也能幫您高價收購。'
    },
    {
      q: '你們在哪裡？',
    ...
    {
      q: '你們是合法的嗎？',
      a: '我們是合法政府立案的珠寶銀樓，合規登記的珠寶銀樓，現場有專業儀器鑑定+專業鑑定師駐點服務。'
    },
    {
      q: '交易後可以反悔嗎？',
