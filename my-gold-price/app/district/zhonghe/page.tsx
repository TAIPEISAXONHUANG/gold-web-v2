...
export const metadata: Metadata = {
  title: '中和區黃金回收推薦2026｜免費估價・當場現金｜巧品珠寶',
  description: '新北市中和區黃金回收推薦！巧品珠寶台北大安區店，搭中和新蘆線至忠孝新生站（直達。老闆親自鑑定、免費估價、現金付款不扣耗損。電話 0986-821-626',
  keywords: '中和區黃金回收,中和區黃金估價,中和區賣黃金,新北市中和區黃金回收',
  alternates: {
    canonical: 'https://www.gold-tw.com/district/zhonghe',
  },
};
  ...
  return (
    <main style={{ padding: '2rem', maxWidth: '800px', margin: '0 auto' }}>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Article",
            "headline": "中和區黃金回收推薦2026｜免費估價・當場現金｜巧品珠寶",
            "description": "新北市中和區黃金回收推薦！巧品珠寶台北大安區店，搭中和新蘆線至忠孝新生站（直達。老闆親自鑑定、免費估價、現金付款不扣耗損。電話 0986-821-626",
            "mainEntityOfPage": { "@type": "WebPage", "@id": "https://www.gold-tw.com/district/zhonghe" },
            ...
            "mainEntity": [
              {
                "@type": "Question",
                "name": "中和區哪裡可以賣黃金？",
                "acceptedAnswer": { "@type": "Answer", "text": "推薦巧品珠寶！位於台北市大安區濟南路三段62-1號。搭中和新蘆線至忠孝新生站（直達），出站步行5分鐘。免費估價、老闆親自鑑定、現場現金付款。" }
              },
              {
                "@type": "Question",
                "name": "中和區黃金回收價格怎麼算？",
              ...
              },
              {
                "@type": "Question",
                "name": "從中和區到巧品珠寶怎麼去？",
                "acceptedAnswer": { "@type": "Answer", "text": "搭中和新蘆線至忠孝新生站（直達），出站步行5分鐘。地址：台北市大安區濟南路三段62-1號。電話：0986-821-626。" }
              }
            ]
          })
        }}
      ...
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"首頁","item":"https://www.gold-tw.com"},{"@type":"ListItem","position":2,"name":"黃金回收地區","item":"https://www.gold-tw.com/district"},{"@type":"ListItem","position":3,"name":"中和區黃金回收推薦2026｜免費估價・當場現金｜巧品珠寶"}]})
        }}
      />
      <h1>中和區黃金回收推薦2026｜巧品珠寶・老闆親自鑑定</h1>

      <p style={{ fontSize: '1.1rem', color: '#555', borderLeft: '4px solid #B8860B', paddingLeft: '1rem', margin: '1.5rem 0' }}>
        中和居民賣黃金，推薦巧品珠寶！從中和站搭捷運中和新蘆線，直達忠孝新生站，約20分鐘。
      </p>

      <h2>為什麼中和區居民選擇巧品珠寶？</h2>
      <ul>
      ...
      <h2>從中和區到巧品珠寶的交通方式</h2>
      <p>搭中和新蘆線至忠孝新生站（直達），出站步行5分鐘</p>
      <p><strong>地址：</strong>台北市大安區濟南路三段62-1號1樓</p>

      <h2>常見問題 FAQ</h2>
      <h3>Q：中和區哪裡可以賣黃金？</h3>
      <p>A：推薦巧品珠寶！搭中和新蘆線至忠孝新生站（直達），出站步行5分鐘。免費估價、老闆親自鑑定、現場現金付款。</p>
      <h3>Q：中和區黃金回收可以當場拿現金嗎？</h3>
      <p>A：可以。確認報價後立即現金付款，不需等隔天。</p>
      <h3>Q：在中和區買的黃金可以到巧品回收嗎？</h3>
