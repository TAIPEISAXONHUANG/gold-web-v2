...
export const metadata: Metadata = {
  title: '新店區黃金回收推薦2026｜免費估價・當場現金｜巧品珠寶',
  description: '新北市新店區黃金回收推薦！巧品珠寶台北大安區店，搭松山新店線至古亭站，轉板南線。老闆親自鑑定、免費估價、現金付款不扣耗損。電話 0986-821-626',
  keywords: '新店區黃金回收,新店區黃金估價,新店區賣黃金,新北市新店區黃金回收',
  alternates: {
    canonical: 'https://www.gold-tw.com/district/xindian',
  },
};
  ...
  return (
    <main style={{ padding: '2rem', maxWidth: '800px', margin: '0 auto' }}>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Article",
            "headline": "新店區黃金回收推薦2026｜免費估價・當場現金｜巧品珠寶",
            "description": "新北市新店區黃金回收推薦！巧品珠寶台北大安區店，搭松山新店線至古亭站，轉板南線。老闆親自鑑定、免費估價、現金付款不扣耗損。電話 0986-821-626",
            "mainEntityOfPage": { "@type": "WebPage", "@id": "https://www.gold-tw.com/district/xindian" },
            ...
            "mainEntity": [
              {
                "@type": "Question",
                "name": "新店區哪裡可以賣黃金？",
                "acceptedAnswer": { "@type": "Answer", "text": "推薦巧品珠寶！位於台北市大安區濟南路三段62-1號。搭松山新店線至古亭站，轉板南線兩站至忠孝新生站，出站步行5分鐘。免費估價、老闆親自鑑定、現場現金付款。" }
              },
              {
                "@type": "Question",
                "name": "新店區黃金回收價格怎麼算？",
              ...
              },
              {
                "@type": "Question",
                "name": "從新店區到巧品珠寶怎麼去？",
                "acceptedAnswer": { "@type": "Answer", "text": "搭松山新店線至古亭站，轉板南線兩站至忠孝新生站，出站步行5分鐘。地址：台北市大安區濟南路三段62-1號。電話：0986-821-626。" }
              }
            ]
          })
        }}
      ...
      <p style={{ fontSize: '1.1rem', color: '#555', borderLeft: '4px solid #B8860B', paddingLeft: '1rem', margin: '1.5rem 0' }}>
        新店居民賣黃金，推薦巧品珠寶！從新店站搭捷運松山新店線，在古亭站轉板南線，約20分鐘可達。
      </p>

      <h2>為什麼新店區居民選擇巧品珠寶？</h2>
      <ul>
      ...
      <h2>從新店區到巧品珠寶的交通方式</h2>
      <p>搭松山新店線至古亭站，轉板南線兩站至忠孝新生站，出站步行5分鐘</p>
      <p><strong>地址：</strong>台北市大安區濟南路三段62-1號1樓</p>

      <h2>常見問題 FAQ</h2>
      <h3>Q：新店區哪裡可以賣黃金？</h3>
      <p>A：推薦巧品珠寶！搭松山新店線至古亭站，轉板南線兩站至忠孝新生站，出站步行5分鐘。免費估價、老闆親自鑑定、現場現金付款。</p>
      <h3>Q：新店區黃金回收可以當場拿現金嗎？</h3>
