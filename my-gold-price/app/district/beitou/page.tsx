...
export const metadata: Metadata = {
  ...
  description: '台北市北投區黃金回收推薦！巧品珠寶台北大安區店，搭淡水信義線至中正紀念堂站，轉。老闆親自鑑定、免費估價、現金付款不扣耗損。電話 0986-821-626',
  keywords: '北投區黃金回收,北投區黃金估價,北投區賣黃金,台北市北投區黃金回收',
  alternates: {
  ...
  return (
    <main style={{ padding: '2rem', maxWidth: '800px', margin: '0 auto' }}>
      ...
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"首頁","item":"https://www.gold-tw.com"},{"@type":"ListItem","position":2,"name":"黃金回收地區","item":"https://www.gold-tw.com/district"},{"@type":"ListItem","position":3,"name":"北投區黃金回收推薦2026｜免費估價・當場現金｜巧品珠寶"}]})
        }}
      />
      ...
      <p style={{ fontSize: '1.1rem', color: '#555', borderLeft: '4px solid #B8860B', paddingLeft: '1rem', margin: '1.5rem 0' }}>
        北投區居民賣黃金，推薦巧品珠寶！從北投站搭捷運淡水信義線，轉乘約30分鐘可達大安區。
      </p>
