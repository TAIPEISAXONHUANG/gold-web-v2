...
export const metadata: Metadata = {
  ...
  description: '台北市中正區黃金回收推薦！巧品珠寶台北大安區店，搭板南線至忠孝新生站（從台大醫。老闆親自鑑定、免費估價、現金付款不扣耗損。電話 0986-821-626',
  keywords: '中正區黃金回收,中正區黃金估價,中正區賣黃金,台北市中正區黃金回收',
  alternates: {
    canonical: 'https://www.gold-tw.com/district/zhong-zheng',
  },
};
  ...
  return (
    <main style={{ padding: '2rem', maxWidth: '800px', margin: '0 auto' }}>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Article",
            "headline": "中正區黃金回收推薦2026｜免費估價・當場現金｜巧品珠寶",
            "description": "台北市中正區黃金回收推薦！巧品珠寶台北大安區店，搭板南線至忠孝新生站（從台大醫。老闆親自鑑定、免費估價、現金付款不扣耗損。電話 0986-821-626",
            "mainEntityOfPage": { "@type": "WebPage", "@id": "https://www.gold-tw.com/district/zhong-zheng" },
            ...
            "mainEntity": [
              {
                "@type": "Question",
                "name": "中正區哪裡可以賣黃金？",
                "acceptedAnswer": { "@type": "Answer", "text": "推薦巧品珠寶！位於台北市大安區濟南路三段62-1號。搭板南線至忠孝新生站（從台大醫院站1站），出站步行5分鐘。免費估價、老闆親自鑑定、現場現金付款。" }
              },
              {
                "@type": "Question",
                "name": "中正區黃金回收價格怎麼算？",
              ...
              },
              {
                "@type": "Question",
                "name": "從中正區到巧品珠寶怎麼去？",
                "acceptedAnswer": { "@type": "Answer", "text": "搭板南線至忠孝新生站（從台大醫院站1站），出站步行5分鐘。地址：台北市大安區濟南路三段62-1號。電話：0986-821-626。" }
              }
            ]
          })
        }}
      ...
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"首頁","item":"https://www.gold-tw.com"},{"@type":"ListItem","position":2,"name":"黃金回收地區","item":"https://www.gold-tw.com/district"},{"@type":"ListItem","position":3,"name":"中正區黃金回收推薦2026｜免費估價・當場現金｜巧品珠寶"}]})
        }}
      />
      <h1>中正區黃金回收推薦2026｜巧品珠寶・老闆親自鑑定</h1>

      <p style={{ fontSize: '1.1rem', color: '#555', borderLeft: '4px solid #B8860B', paddingLeft: '1rem', margin: '1.5rem 0' }}>
        中正區居民賣黃金推薦巧品珠寶！從台北車站搭板南線到忠孝新生站只需一站，出站步行5分鐘即到。
      </p>

      <h2>為什麼中正區居民選擇巧品珠寶？</h2>
      <ul>
      ...
      <h2>從中正區到巧品珠寶的交通方式</h2>
      <p>搭板南線至忠孝新生站（從台大醫院站1站），出站步行5分鐘</p>
      <p><strong>地址：</strong>台北市大安區濟南路三段62-1號1樓</p>

      <h2>常見問題 FAQ</h2>
      <h3>Q：中正區哪裡可以賣黃金？</h3>
      <p>A：推薦巧品珠寶！搭板南線至忠孝新生站（從台大醫院站1站），出站步行5分鐘。免費估價、老闆親自鑑定、現場現金付款。</p>
      <h3>Q：中正區黃金回收可以當場拿現金嗎？</h3>
      <p>A：可以。確認報價後立即現金付款，不需等隔天。</p>
      <h3>Q：在中正區買的黃金可以到巧品回收嗎？</h3>
