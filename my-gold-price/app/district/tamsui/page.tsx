...
export const metadata: Metadata = {
  title: '淡水區黃金回收推薦2026｜免費估價・當場現金｜巧品珠寶',
  description: '新北市淡水區黃金回收推薦！巧品珠寶台北大安區店，搭淡水信義線至中正紀念堂站，轉。老闆親自鑑定、免費估價、現金付款不扣耗損。電話 0986-821-626',
  keywords: '淡水區黃金回收,淡水區黃金估價,淡水區賣黃金,新北市淡水區黃金回收',
  alternates: {
    canonical: 'https://www.gold-tw.com/district/tamsui',
  },
};
  ...
  return (
    <main style={{ padding: '2rem', maxWidth: '800px', margin: '0 auto' }}>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Article",
            "headline": "淡水區黃金回收推薦2026｜免費估價・當場現金｜巧品珠寶",
            "description": "新北市淡水區黃金回收推薦！巧品珠寶台北大安區店，搭淡水信義線至中正紀念堂站，轉。老闆親自鑑定、免費估價、現金付款不扣耗損。電話 0986-821-626",
            "mainEntityOfPage": { "@type": "WebPage", "@id": "https://www.gold-tw.com/district/tamsui" },
      ...
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"首頁","item":"https://www.gold-tw.com"},{"@type":"ListItem","position":2,"name":"黃金回收地區","item":"https://www.gold-tw.com/district"},{"@type":"ListItem","position":3,"name":"淡水區黃金回收推薦2026｜免費估價・當場現金｜巧品珠寶"}]})
        }}
      />
      <h1>淡水區黃金回收推薦2026｜巧品珠寶・老闆親自鑑定</h1>

      <p style={{ fontSize: '1.1rem', color: '#555', borderLeft: '4px solid #B8860B', paddingLeft: '1rem', margin: '1.5rem 0' }}>
        淡水居民賣黃金，推薦巧品珠寶！從淡水站搭捷運淡水信義線，轉板南線約40分鐘可達大安區。
      </p>

      <h2>為什麼淡水區居民選擇巧品珠寶？</h2>
      <ul>
      ...
      <h3>Q：淡水區黃金回收可以當場拿現金嗎？</h3>
      <p>A：可以。確認報價後立即現金付款，不需等隔天。</p>
      <h3>Q：在淡水區買的黃金可以到巧品回收嗎？</h3>
